...
namespace GuardianStock.Domain.Products
{
    public class Product : Aggregate, IAuditable
    {
        ...
        private Product(Guid id, string name, string sku, string description, decimal price, string supplier, Guid categoryId, string? imageUrl) : base(id)
        {
            Name = name;
            Sku = sku;
        ...
        public static Result<Product> Create(string name, string sku, string description, decimal price, string supplier, Guid categoryId, string? imageUrl = null)
        {
            ...
            var newProduct = new Product(newId, name, sku, description, price, supplier, categoryId, imageUrl);
